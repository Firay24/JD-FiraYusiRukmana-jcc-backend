-- CreateEnum
CREATE TYPE "StageType" AS ENUM ('TK', 'SD', 'SMP');
...
-- CreateEnum
CREATE TYPE "Subdistrict" AS ENUM ('PESANGGARAN', 'SILIRAGUNG', 'BANGOREJO', 'PURWOHARJO', 'TEGALDLIMO', 'MUNCAAR', 'CLURING', 'GAMBIRAN', 'TEGALSARI', 'GLENMORE', 'KALIBARU', 'GENTENG', 'SRONO', 'ROGOJAMPI', 'BLIMBINGSARI', 'KABAT', 'SINGOJURUH', 'SEMPU', 'SONGGON', 'GLAGAH', 'LICIN', 'BANYUWANGI', 'GIRI', 'KALIPURO', 'WONGSOREJO');
...
CREATE TABLE "School" (
    ...
    "DateUpdate" TIMESTAMP(3),
    "Name" TEXT NOT NULL,
    "Subdistrict" "Subdistrict" NOT NULL,
    "Ward" TEXT NOT NULL,
